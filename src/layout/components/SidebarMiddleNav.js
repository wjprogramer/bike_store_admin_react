...
export const SidebarMiddleNav = () => (
    <SidebarMenu>
        ...
        >
            ...
            <SidebarMenu.Item title="Grid System" to='/layouts/grid-system' exact />
        </SidebarMenu.Item>
        { /* -------- Interface ---------*/ }
        <SidebarMenu.Item
        ...
        >
            ...
            <SidebarMenu.Item title="Carousels" to='/interface/carousels' />
        </SidebarMenu.Item>
        { /* -------- Graphs ---------*/ }
        <SidebarMenu.Item
        ...
        >
            ...
            <SidebarMenu.Item title="Image Input" to='/forms/image-input' />
        </SidebarMenu.Item>
        { /* -------- Tables ---------*/ }
        <SidebarMenu.Item
        ...
        { /* -------- Playgrounds of Jay ---------*/ }
        <SidebarMenu.Item
            icon={<i className="fa fa-fw fa-gamepad"></i>}
            title="Playgrounds"
        >
            <SidebarMenu.Item title="Redux" to='/playgrounds/jay-demo-1' />
            <SidebarMenu.Item title="I18N" to='/playgrounds/jay-demo-2' />
            <SidebarMenu.Item title="GraphQL" to='/playgrounds/jay-demo-3' />
            <SidebarMenu.Item title="Jumbotrons" to='/playgrounds/jumbotrons' />
            <SidebarMenu.Item title="Some Components" to='/playgrounds/some-components' />
            <SidebarMenu.Item title="FlowJsDemo" to='/playgrounds/flow-js' />
        </SidebarMenu.Item>
        <SidebarMenu.Item
