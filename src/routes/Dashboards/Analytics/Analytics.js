...
export const Analytics = () => {
  const [layouts, setLayouts] = useState(_.clone(LAYOUT));

  const _resetLayout = () => {
    setLayouts(_.clone(LAYOUT));
  }
        ...
        >
          ...
          <Grid.Col {...(applyColumn('website-performance', layouts))}>
            <Card>
              ...
              <ListGroup flush>
                <ListGroupItem className="bt-0" active tag="a" href="#" action>
                  <WebsitePerformance
                ...
                <ListGroupItem className="bt-0" color="primary">
                  <WebsitePerformance
                    title="Pageviews (Avg)"
                    value="2.15"
                ...
                <ListGroupItem className="bt-0 bb-0">
                  <ListGroupItemHeading>Conclustion</ListGroupItemHeading>
                  <ListGroupItemText>
                    しかしまたは今一般があり事もとても自由と伴うんて、漠然たる甲をは取次いないがという子弟が限らてくるならたら。
                                      </ListGroupItemText>
                </ListGroupItem>
              </ListGroup>
