...
import Carousels from './Interface/Carousels';
...
import JayDemo1 from './../containers/JayDemo/JayDemo1Container1';
import JayDemo2 from './Playgrounds/JayDemo2';
import JayDemo3 from './Playgrounds/JayDemo3';
import Jumbotrons from './Playgrounds/Jumbotrons';
import SomeComponents from './Playgrounds/SomeComponents';
import FlowJsDemo from './Playgrounds/FlowJsDemo';
...
const MainRoutes = () => {
  return (
    <Switch>
      ...
      <Route path='/layouts/grid-system' component={GridSystem} />
      ...
      <Route component={ Carousels } path="/interface/carousels" />
      ...
      <Route component={ ImageInput } path="/forms/image-input" />
      ...
      { /*    Playgrounds of Jay    */ }
      <Route component={ JayDemo1 } path="/playgrounds/jay-demo-1" />
      <Route component={ JayDemo2 } path="/playgrounds/jay-demo-2" />
      <Route component={ JayDemo3 } path="/playgrounds/jay-demo-3" />
      <Route component={ Jumbotrons } path="/playgrounds/jumbotrons" />
      <Route component={ SomeComponents } path="/playgrounds/some-components" />
      <Route component={ FlowJsDemo } path="/playgrounds/flow-js" />
