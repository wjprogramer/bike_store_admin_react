...
const Cards = () => (
    <React.Fragment>
        <Container>
            ...
            />
            <p>
                專案的 Card 有被包過一層，因此行為不一定和官方範例相同
            </p>
            { /* START Header 1 */}
            <Row>
                <Col lg={ 12 }>
            ...
            <Row>
                <Col lg={ 12 }>
                    <HeaderDemo 
                        no={0} 
                        title="Others" 
                        subTitle="From reactscap example ~ Jay"
                        className="mt-5"  
                    />
                </Col>
            </Row>
            ...
            <Row>
                <Col lg={ 6 }>
                    <Card className="mb-3">
                        <CardImg top width="100%" src={require("../../../images/placeholders/318x180.svg").default} alt="Card image cap" />
                        <CardBody>
                    ...
                    <Card className="mb-3">
                        ...
                        <img width="100%" src={require("../../../images/placeholders/318x180.svg").default} alt="Card image cap" />
                        <CardBody>
                            <CardText>Some quick example text to build on the card title and make up the bulk of the card's content.</CardText>
                    ...
                    <Card inverse className="mb-3">
                        <CardImg width="100%" src={require("../../../images/placeholders/318x180.svg").default} alt="Card image cap" />
                        <CardImgOverlay>
                            <CardTitle>Card Title</CardTitle>
                    ...
                    <Card body inverse style={{ backgroundColor: '#333', borderColor: '#333' }} className="mb-3">
                        <CardTitle>Special Title Treatment</CardTitle>
                        <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
                        <Button>Button</Button>
                    </Card>
                    <Card body color="primary" className="mb-3">
                        <CardTitle>Special Title Treatment</CardTitle>
                        <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
                ...
                <Col lg={ 6 }>
                    ...
                    <Card body className="mb-3 text-right">
                        <CardTitle>Special Title Treatment</CardTitle>
                        <CardText>With supporting text below as a natural lead-in to additional content.</CardText>
                        <Button>Go somewhere</Button>
                    </Card>
                    ...
                    <Card className="mb-3">
                        ...
                        <CardImg bottom width="100%" src={require("../../../images/placeholders/318x180.svg").default} alt="Card image cap" />
                    </Card>
                </Col>
            </Row>
            <Row>
            ...
            <Row>
                <Col lg={ 12 }>
                    <CardDeck className="mb-3">
                        <Card>
                            <CardImg top width="100%" src={require("../../../images/placeholders/256x186.svg").default} alt="Card image cap" />
                            <CardBody>
                            <CardTitle>Card title</CardTitle>
                            <CardSubtitle>Card subtitle</CardSubtitle>
                            <CardText>This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</CardText>
