...
import AccordionDemo1 from './demo/AccordionDemo1';
import AccordionDemo2 from './demo/AccordionDemo2';
import AccordionDemo3 from './demo/AccordionDemo3';
                    ...
                    <div className="mb-5">
                        ...
                        <Accordion className="mb-2">
                            <Accordion.Header className='h6'>
                                <Accordion.Indicator 
                                    className="mr-2"
                                    open={<i className="fa fa-chevron-down fa-fw" style={{ transform: "rotate(180deg)", transition: "all .3s ease 0s" }}></i>}
                                    closed={<i className="fa fa-chevron-down fa-fw" style={{ transform: "rotate(0deg)", transition: "all .3s ease 0s" }}></i>}
                                />
                                Accordion Card #2
                            </Accordion.Header>
                            <Accordion.Body>
