...
import BsDropdownDemo1 from "./demo/BsDropdownDemo1";
...
const Buttons = (props) => {
    ...
    // 9.01 button dropdown
    const [dropdownOpen, setOpen] = useState(false);
    const toggle = () => setOpen(!dropdownOpen);

    // 9.02 button dropdown
    const [isOpen, setOpen902] = useState(false);
    const toggle902 = () => setOpen902(!isOpen);
    
    // 9.03 button dropdown
    const [isOpen903, setOpen903] = useState(false);
    const toggle903 = () => setOpen903(!isOpen903);
            ...
            <Container>
                    ...
                    <Col lg={ 4 }>
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <br />
                                <Button color="secondary" className="mb-2" outline>
                                    <i className="fa fa-folder-open-o mr-2"></i>
                                    Small Button
                                </Button>{' '}
                                <br />
                    ...
                    <Col lg={ 4 }>
                        ...
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <p>
                                    Use a generic close icon to dismiss content. Use <code>&lt;Button close /&gt;</code> for the default icon.
                                </p>
                                <Button close></Button>
                            </CardBody>
                        </Card>
                    ...
                    <Col lg={ 4 }>
                        ...
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <p>
                                    custom content for the button may be defined. (e.g. JSX: <code>&lt;Button close&gt;&lt;span aria-hidden="true"&gt;–&lt;/span&gt;&lt;/Button&gt;</code>) The default aria-label is "Close".
                                </p>
                        ...
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <ButtonGroup vertical>
                                    ...
                                    <Button className="ml-0" outline>2</Button>
                                    <UncontrolledButtonDropdown>
                    ...
                    <Col lg={ 4 }>
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <p>
                                    Bootstrap <code>checkbox</code> button group<br />
                        ...
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <p>
                                    Bootstrap <code>radio</code> button group <br />
                                    Selected: {rSelected}
                                </p>
                                <ButtonGroup>
                ...
                <Row>
                    <Col lg={ 12 }>
                        <HeaderDemo 
                            no={9} 
                            title="Controlled Button Dropdown" 
                            className="mt-5"
                            subTitle="Controlled Dropdown by Jay"
                        />
                    </Col>
                </Row>
                { /* END Header 9 */}
                    ...
                    <Col lg={ 4 }>
                        ...
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <ButtonDropdown isOpen={isOpen} toggle={toggle902}>
                    ...
                    <Col lg={ 4 }>
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <p></p>
                                <ButtonDropdown isOpen={isOpen903} toggle={toggle903}>
                                    <Button id="caret" color="primary">Dropdown Button</Button>
                ...
                <Row>
                    <Col lg={ 12 }>
                        <HeaderDemo 
                            ...
                            title="TODO" 
                            className="mt-5"
                            subTitle="參考 creative-tim 的 paper-dashboard-template"
                        />
                    </Col>
                </Row>
                { /* END Header Jay */}
                    ...
                    <Col lg={ 4 }>
                        <Card className="mb-3">
                            <CardBody>
                                ...
                                <Button color="primary" className="mb-2 mr-1 ml-0">
                                    <i className="fa fa-gear mr-2"></i>
                                    INFO
                                </Button>{' '}
                                <Button color="success" className="mb-2 mr-1 ml-0">
                                    <i className="fa fa-check mr-2"></i>
                                    SUCCESS
                                </Button>{' '}
                                <Button color="warning" className="mb-2 mr-1 ml-0">
                                    <i className="fa fa-search mr-2"></i>
                                    WARNING
                                </Button>{' '}
                                <Button color="danger" className="mb-2 mr-1 ml-0">
                                    <i className="fa fa-remove mr-2"></i>
                                    DANGER
                                </Button>{' '}
                                <Button color="dark" className="mb-2 mr-1 ml-0">
